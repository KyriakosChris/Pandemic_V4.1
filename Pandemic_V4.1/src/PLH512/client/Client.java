				...
				while (currentBoard[0].getGameEnded() == false) {
					...
					try {
						...
						if (timeToTalk) {
							...
							if (myAction.contains("TD"))
								a.setTotalTreats(a.getTotalTreats() + 1);
							if (myAction.contains("CD1") || myAction.contains("CD2"))
								a.setTotalCures(a.getTotalCures() + 1);
							System.err.println("Total Treats: " + a.getTotalTreats() + " Total Cures: " + a.getTotalCures());
